...
docker build --platform linux/amd64 -t dena-training-2024-team-7-db -f ./docker/mongodb.Dockerfile .
...
aws ecs update-service --cluster dena-training-2024 --service dena-training-2024-team-7 --task-definition dena-training-2024-team-7:13